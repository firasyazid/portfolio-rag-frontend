                ...
                <div className="space-y-6">
                  ...
                  {education.map((edu, i) => (
                    <div key={i} className="border-l-2 border-indigo-500/30 pl-6 pb-6 hover:border-indigo-500 transition-colors">
                      <div className="text-xs text-indigo-400 mb-2 font-mono">{edu.date}</div>
                      <div className="text-xl text-white font-semibold mb-1">{edu.title}</div>
                      <div className="text-indigo-300 mb-2">{edu.institution}</div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {certifications.map((cert, i) => (
                      ...
                      >
                        ...
                        <div className="text-violet-400 text-sm mb-1">by {cert.issuer}</div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    {Object.entries(skills).map(([category, items]) => (
                      <div key={category}>
                        <div className="text-sm text-blue-400 uppercase tracking-wider mb-3 font-semibold">
                          {category}
                        </div>
