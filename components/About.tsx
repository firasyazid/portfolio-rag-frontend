...
export default function About() {
  ...
  const experiences = d.raw("experiences") as Experience[];
  const education = d.raw("education") as Education[];
  ...
  const menuItems = [
    { id: "about" as Section, label: t('tab_about'), icon: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    { id: "experience" as Section, label: t('tab_experience'), icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
    { id: "education" as Section, label: t('tab_education'), icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
    { id: "certifications" as Section, label: t('tab_certifications'), icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" },
    { id: "skills" as Section, label: t('tab_skills'), icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
  ];
            ...
            <div className="flex-1 p-4 md:p-8 h-[500px] md:h-[600px] overflow-y-auto scrollbar-thin">
              {activeSection === "about" && (
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-white mb-6">{t('about_title')}</h3>
              ...
              {activeSection === "experience" && (
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-white mb-6">{t('experience_title')}</h3>
              ...
              {activeSection === "education" && (
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-white mb-6">{t('education_title')}</h3>
                  {education.map((edu, i) => (
              ...
              {activeSection === "certifications" && (
                <div>
                  <h3 className="text-2xl font-bold text-white mb-6">{t('certifications_title')}</h3>
              ...
              {activeSection === "skills" && (
                <div>
                  <h3 className="text-2xl font-bold text-white mb-6">{t('skills_title')}</h3>
                  <div className="space-y-6">
