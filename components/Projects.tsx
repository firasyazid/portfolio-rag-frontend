...
export default function Projects() {
    ...
    const projects: Project[] = [
        ...
        {
            id: "generative-ui-restaurant-agent",
            filename: "RestaurantAgent.tsx",
            title: "Generative UI Restaurant Agent — CopilotKit AG-UI · Mastra · React Native",
            description: "React Native app where an AI agent recommends dishes from a restaurant menu based on your profile and message — and instead of replying in text, it renders native dish cards inline in the chat. The agent knows allergies and diet before you start; the menu in context is pre-filtered so restricted items never reach the model — an architectural guarantee, not a prompt rule.",
            techStack: [
                "CopilotKit AG-UI",
                "Mastra",
                "DeepSeek Flash 4 (OpenRouter)",
                "React Native",
                "Expo",
                "LibSQL",
                "TypeScript",
            ...
            features: [
                "Profile-aware recommendations (allergies, diet) with menu filtered before the agent sees it",
                "User message → profile read → menu filter → dish pick → native cards rendered inline (no text lists)",
                "Generative UI driven by the model through AG-UI tool calls",
                "Native dish cards in chat instead of markdown replies",
                "Built with Mastra agent orchestration and CopilotKit AG-UI protocol",
            ],
            githubUrl: "https://github.com/firasyazid/generative-ui-restaurant-agent",
            category: "Web & AI",
            primaryIcon: TbBrandReactNative,
        },
        {
            id: "agentic-gen-ui-chat",
            filename: "AgenticGenUI.tsx",
            title: "Agentic Gen UI Chat — Mastra, AG-UI & MCP",
            description: "An AI-powered chat assistant that connects to Slack & Jira and generates dynamic UI components in real time — not text replies, but rendered interfaces tailored to each answer. Ask about your project; the agent reasons over live workspace data and responds with the right UI: task boards, blocker cards, team timelines, and more.",
            techStack: [
                "Next.js",
                "Vercel AI SDK",
                "Mastra",
            ...
            features: [
                "Every response is a freshly generated UI component, not a plain text answer",
                "Mastra agent with custom tools over Slack & Jira workspace data",
                "AG-UI protocol linking agentic backend to a live user-facing app",
                "Dynamic interfaces: task boards, blocker cards, team timelines, and more",
                "Reasoning over real project data to pick the right component for each question",
            ],
            videoUrl: "https://drive.google.com/file/d/1010T0Z3JXpsqNhXw3ILaaFtiVBM2dEis/view",
            category: "Web & AI",
            primaryIcon: SiNextdotjs,
        },
        {
